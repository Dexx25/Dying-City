...
public class EnemyWaves : MonoBehaviour
{
    ...
    void Start(){
        ...
        if (sceneName == "Night1" ||sceneName == "Night2"){
          ...
          Instantiate(EnemyPrefab,transform.position+ new Vector3(0f, 0f, 0f),Quaternion.identity);
    ...
    public void SpawnBoss(){
      Instantiate(BossPrefab,transform.position+ new Vector3(0f, 0f, 0f),Quaternion.identity);
    }
}
